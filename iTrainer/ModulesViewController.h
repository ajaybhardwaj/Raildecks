...
@interface ModulesViewController : UIViewController <AVAudioPlayerDelegate> {
    ...
    UIButton *removeKeypadButton,*nextButton,*usermanualButton,*majorcomponentButton,*backButton;
    
    
    UIWebView *contentWebView;
    UIButton *forwardButton,*previousButton,*reviewModuleButton,*takeTestButton,*closeButton;
    ...
    NSString *videosPath,*audiosPath,*imagesPath;
}
