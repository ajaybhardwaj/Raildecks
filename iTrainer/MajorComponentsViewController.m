//
//  MajorComponentsViewController.m
//  iTrainer
//
//  Created by Ajay Bhardwaj on 16/09/13.
//  Copyright (c) 2013 ajay@sabnetworks.com. All rights reserved.
//

#import "MajorComponentsViewController.h"

@interface MajorComponentsViewController ()

@end

@implementation MajorComponentsViewController
...
-(void)viewDidLoad {
    ...
    loginLabel.text = [NSString stringWithFormat:@"MAJOR COMPONENTS"];
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"majorcomponents" ofType:@"pdf"];
